...
@FixtureClass
public class ParsingHtmlFixture {
    public String html;

    public Tables structure() {
        HtmlDocumentBuilder parser = HtmlDocumentBuilder.tablesAndLists();
        Example example = parser.parse(html);
        return Tables.parse(Tables.toMarkup(example, false));
    }
}
