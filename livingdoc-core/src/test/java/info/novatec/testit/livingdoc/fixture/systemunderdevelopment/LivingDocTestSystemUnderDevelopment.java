...
public class LivingDocTestSystemUnderDevelopment extends DefaultSystemUnderDevelopment {

    public LivingDocTestSystemUnderDevelopment() {
        addImports();
    }

    public LivingDocTestSystemUnderDevelopment(String... params) {
        this();
    }
    ...
    private void addImports() {
        ...
        addImport("info.novatec.testit.livingdoc.interpreter.flow.workflow");
        ...
        addImport("info.novatec.testit.livingdoc.fixture.interpreter.flow.workflow");
